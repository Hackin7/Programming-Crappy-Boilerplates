#Derived from https://github.com/Finspire13/pytorch-policy-gradient-example/blob/master/pg.py
import torch
...
def save_model(net, path):
    torch.save( dict(model=net.state_dict()), path)
...
def main():
    ...
    load_model(policy_net, SAVE_PATH)
